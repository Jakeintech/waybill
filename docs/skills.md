...
| `cache` | `/waybill:cache` | action | What the bill is made of: volume by cache tier, effective vs list cost (derived), the cache-read share | "why is my bill like this", "what am I actually billed for", "cache usage" |
